...
#define GPS_USART_RX_GPIO_CLK                 RCC_APB2Periph_GPIOD
#define GPS_USART_RX_PIN                      GPIO_Pin_9


#define GPS_USART_TX_GPIO_PORT                GPIOD
#define GPS_USART_TX_GPIO_CLK                 RCC_APB2Periph_GPIOD
#define GPS_USART_TX_PIN                      GPIO_Pin_8
/************************************************************/
#define GPS_DMA                      DMA1
#define GPS_DMA_CLK                  RCC_AHBPeriph_DMA1
#define GPS_DMA_CHANNEL              DMA1_Channel2
#define GPS_DMA_IRQn                 DMA1_Channel2_IRQn         //GPS中断源

/* 外设标志 */
#define GPS_DMA_FLAG_TC              DMA1_FLAG_TC2
#define GPS_DMA_FLAG_TE              DMA1_FLAG_TE2
#define GPS_DMA_FLAG_HT              DMA1_FLAG_HT2
#define GPS_DMA_FLAG_GL              DMA1_FLAG_GL2
#define GPS_DMA_IT_HT                DMA1_IT_HT2
#define GPS_DMA_IT_TC                DMA1_IT_TC2


/* 中断函数 */
#define GPS_DMA_IRQHANDLER           DMA1_Channel2_IRQHandler   //GPS使用的DMA中断服务函数
